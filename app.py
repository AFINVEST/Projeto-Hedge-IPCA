...
def process_df():
    ...
    df_posicao = pd.read_excel('Relatório de Posição 2025-03-13.xlsx', sheet_name='Worksheet')
    ...
    outros = ["BRFS31","CRA Ferroeste 2ª Série","CRI Bem Brasil", "NTN-B26", "NTN-B28","NTN-B30", "NTN-B32","NTN-B50"]
