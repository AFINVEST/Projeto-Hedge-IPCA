...
def process_df():
    ...
    df_posicao = pd.read_excel('Relatório de Posição 2025-03-27.xlsx', sheet_name='Worksheet')
    df_debentures = pd.read_csv('deb_table_completa4.csv')
    ...
    outros = ["BRFS31","CRA Ferroeste 2ª Série","CRI Bem Brasil", "NTN-B26", "NTN-B28","NTN-B30", "NTN-B32","NTN-B50",'CRI Vic Engenharia 1ª Emissão','TBCR18','CRTA12','CERT11']
...
def main():
    ...
    if selected_filters:
        ...
        colL1, colL2, colL3 = st.columns([4.9, 0.2, 4.9])
